...
public class Programa {
	...
	public static void main(String[] args) {
		...
		contaCorrente.agencia = "987";
		contaCorrente.numeroConta = "111";
		contaCorrente.nomeTitular = "Joao";
		...
		contaPoupanca.agencia = "654";
		contaPoupanca.numeroConta = "222";
		contaPoupanca.nomeTitular = "Maria";
		...
		contaSalario.agencia = "321";
		contaSalario.numeroConta = "333";
		contaSalario.nomeTitular = "Ana";
